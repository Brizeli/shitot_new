...
@NamedQueries({
                  ...
                  @NamedQuery(name = Doctor.GET_WITH_CERTIFICATE, query = "select d from doctors d left join fetch d.certificate c " +
                                                                              "where d.id=:id order by lower(d.fullName)"),
...
public class Doctor extends UserDoctor {
    ...
    public static final String GET_WITH_CERTIFICATE = "Doctor.getWithCertificate";
    ...
    public Doctor(Integer id, String fullName, String login, String password, String email, String telNumber,
                  String telHome, String homeAddress, String lections, String preferential, String comments) {
